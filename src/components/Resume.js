      ...
      <div style={container}>
        ...
        <div style={resumeItem}>
          ...
          >
            <img
              style={imgStyle}
              src={`${process.env.PUBLIC_URL}/PlayStation.png`}
              alt=""
            />
          ...
          >
            <ul>
              ...
              <li>
                Managed the release process of applications that ship to
                millions of PlayStation network users
              </li>
        ...
        <div style={resumeItem}>
          ...
          >
            <img
              style={imgStyle}
              src={`${process.env.PUBLIC_URL}/SFSU.png`}
              alt=""
            />
