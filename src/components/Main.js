...
class Main extends React.Component {
  ...
  componentDidMount() {
    const preload = [{name: 'beachLoaded', src: `${process.env.PUBLIC_URL}/blue_ocean.jpeg`}]
  ...
  render() {
    ...
    <div style={backgroundStyle}>
        ...
        <TextBubble avatar={`${process.env.PUBLIC_URL}/profile.jpg`} content={"Hello there, my name is Yukio. I'm an experienced Software Engineer"} />
